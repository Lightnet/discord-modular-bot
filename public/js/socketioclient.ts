...
var DataID:any = function(){
	this.name = ko.observable();
    this.id = ko.observable();
}
//guilds model
var GuildDataModel:any = function (_id, _name,_obj) {
...
//member view
var MembersViewModel:any = function (){
	this.members = ko.observableArray([])
}
// member view model
...
//channel list
var ChannelsViewModel:any = function (){
	this.channels = ko.observableArray([])
}
//channel view model
var channelsviewmodel = new ChannelsViewModel();
// guild view model
var GuildsViewModel:any = function () {
    ...
    this.guildid.subscribe(function(newValue) {
        ...
        for (i in self.guilds()){
          if(self.guilds()[i].id() == newValue){
			if(membersviewmodel!=null){membersviewmodel.members(self.guilds()[i].members());}
			self.guilds()[i].channels().sort(
				function(a, b) { return a.type() > b.type();}
			);
			if(channelsviewmodel!=null){channelsviewmodel.channels(self.guilds()[i].channels());}
          }
        }
    });
    this.clearserver = function(){
		this.guilds([]);
		if(membersviewmodel !=null){membersviewmodel.members([]);}
		if(channelsviewmodel!=null){channelsviewmodel.channels([]);}
    }
}
//===============================================
// #socket.io
